...
module Users
  class DocumentsController < BaseController
    ...
    def index
      ...
      return unless params[:document_file_id]

      sheets_service = ::Google::Apis::SheetsV4::SheetsService.new
      sheets_service.authorization = google_authorization
      document_file_id = params[:document_file_id]
      results = sheets_service.batch_get_spreadsheet_values(document_file_id, ranges: "B4:AC1000").value_ranges.first.values
      results.each do |result|
        doc = Docx::Document.open("#{Rails.root}/public/document_automation.docx")
        folder_id = result[19].split("/")[5]
        time = result[1].split("/")
        ...
        source = "#{Rails.root}/public/#{result[5]}.docx"
        doc.save(source)
      ...
      # DocumentAutomationJob.perform_later(
